  ...
  return (
    <>
      <StorySection title="Basic tooltip">
        <Tooltip
          trigger={<Button variant={ButtonVariant.Primary}>Hover me</Button>}
      ...
      <StorySection title="Tooltip with custom content">
        <Tooltip
          trigger={<Button variant={ButtonVariant.Primary}>Hover for custom content</Button>}
          content={
            <FlexRow gap={8}>
      ...
      <StorySection title="Tooltip with keyboard shortcut">
        <Tooltip
          trigger={<Button variant={ButtonVariant.Primary}>Hover for shortcut</Button>}
