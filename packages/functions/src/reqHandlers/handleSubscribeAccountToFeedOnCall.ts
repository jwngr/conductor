...
export interface SubscribeAccountToFeedOnCallResponse {
  readonly feedSourceId: FeedSourceId;
  readonly userFeedSubscriptionId: UserFeedSubscriptionId;
}

export async function handleSubscribeAccountToFeedOnCallRequest(args: {
  readonly accountId: AccountId;
  readonly parsedUrl: URL;
  readonly rssFeedService: ServerRssFeedService;
}): Promise<SubscribeAccountToFeedOnCallResponse> {
